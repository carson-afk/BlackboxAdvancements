...
(function () {
  ...
  if (contactForm) {
    contactForm.addEventListener('submit', function (e) {
      ...
      var body = [
        "Hi Palmer's Concrete Coatings team,", '',
      ...
      try {
        ...
        window.location.href = 'mailto:info@palmersconcretecoatings.com?subject=' + encodeURIComponent(subject) + '&body=' + encodeURIComponent(body);
      } catch (err) {}
    });
  }
